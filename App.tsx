        ...
        <div className="relative py-16 select-none overflow-hidden w-full mb-12">
          <div className="flex items-center whitespace-nowrap animate-marquee">
            <h1 className="text-[5rem] md:text-[7rem] leading-none igma-outline-text hover:text-theme-text hover:text-stroke-0 transition-all duration-700 ease-out mx-4">
              WEB • MOTION • INTERACTION • CREATIVE • DEVELOPER • 
            </h1>
            <h1 className="text-[5rem] md:text-[7rem] leading-none igma-outline-text hover:text-theme-text hover:text-stroke-0 transition-all duration-700 ease-out mx-4">
              WEB • MOTION • INTERACTION • CREATIVE • DEVELOPER • 
            </h1>
          ...
          <div className="flex flex-col items-start md:items-end gap-8">
            ...
            <div className="flex flex-col md:items-end gap-3">
              ...
              <div className="flex items-center gap-6">
                <a href="https://github.com/Subhan-code/Lumina-Transitions-" target="_blank" rel="noreferrer" className="text-lg font-bold hover:text-theme-accent transition-colors flex items-center gap-2 group">
