...
export const DemoCard: React.FC<DemoCardProps> = React.memo(({
  ...
  return (
    <div 
      className={`w-full flex flex-col md:flex-row md:items-center justify-between py-5 px-6 border-2 border-theme-border rounded-[8px] bg-theme-bg group hover:bg-theme-text transition-all duration-200 active:scale-[0.99] cursor-pointer relative overflow-hidden ${
    ...
    >
      <div className="flex items-center gap-8 w-full relative z-10">
        ...
        {/* Title */}
        <h3 className="text-2xl font-bold text-theme-text group-hover:text-theme-bg transition-colors duration-200 font-display tracking-tight">
          {item.name}
        </h3>
      </div>
      ...
      <div className="flex items-center gap-4 mt-4 md:mt-0 ml-auto relative z-10">
        ...
        <div className="flex gap-2">
          <button 
            ...
            className="p-2 rounded-full border border-theme-border group-hover:border-theme-bg text-theme-text group-hover:text-theme-bg hover:scale-110 active:scale-95 transition-all"
            title="View Code"
          >
          ...
          <button 
            ...
            className="px-5 py-2 rounded-full bg-theme-text text-theme-bg group-hover:bg-theme-bg group-hover:text-theme-text font-bold text-sm transition-colors active:scale-95 border border-transparent"
          >
            Preview
          </button>
        </div>
